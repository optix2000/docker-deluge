...
alpine:
	...
	docker build -f Dockerfile.alpine-deluge . -t optix2000/deluge:latest
	docker build -f Dockerfile.alpine-web . -t optix2000/deluge-web:latest
...
debian:
	...
	docker build -f Dockerfile.debian-deluge . -t optix2000/deluge:debian
	docker build -f Dockerfile.debian-web . -t optix2000/deluge-web:debian
